...
// (DO NOT EDIT: machine generated header) 'Tntsystem.pas' rev: 11.00
...
#define UTF8_BOM "﻿"
#define AllTntSystemUpdates (Set<TTntSystemUpdate, tsWideResourceStrings, tsWideResourceStrings> () << tsWideResourceStrings )
...
extern PACKAGE void __fastcall InstallTntSystemUpdates(TTntSystemUpdateSet Updates = (TTntSystemUpdateSet() << tsWideResourceStrings ));
